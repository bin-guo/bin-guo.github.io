...
My research area mainly focuses on parallel and distributed computing, especially on graph algorithms and graph mining. Recently, I have been interested in computer security for data graph analytics. My favourite conferences are ICPP, SPAA, PPoPP, VLDB, and ICDE. My favourite journals are [The Journal of Supercomputing](https://link.springer.com/journal/11227), [IEEE Transactions on Parallel and Distributed Systems (TPDS)](https://www.computer.org/csdl/journal/td), and [Journal of Parallel and Distributed Computing (JPDC)](https://www.sciencedirect.com/journal/journal-of-parallel-and-distributed-computing).
...
-->
<!--
<span style="color:red; font-size:20px;">Currently, I am recruiting highly motivated Master's and PhD students! For details see my section "Recruit Students".</span> 
-->
